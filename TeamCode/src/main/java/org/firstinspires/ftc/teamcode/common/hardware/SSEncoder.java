...
public class SSEncoder {
    ...
    public SSEncoder(DcMotorEx motor, NanoClock clock) {
        this.motor = motor;
        this.clock = clock;
    ...
    public SSEncoder(DcMotorEx motor) {
    ...
    /**
     * Allows you to set the direction of the counts and velocity without modifying the motor's direction armState
