...
//                .build()
        ...
        val moveToArmDropPurple =
            when (zoneDetected) {
                PropZoneDetected.LEFT -> smec.setArmState(ScoringMechanism.State.CLOSE_INTAKE)
                PropZoneDetected.CENTER, PropZoneDetected.NONE -> smec.setArmState(ScoringMechanism.State.CLOSE_INTAKE)
                PropZoneDetected.RIGHT -> smec.setArmState(ScoringMechanism.State.EXTENDED_INTAKE)
            }
