...
public class ElbowConfig {
    ...
    public static double ELBOW_EXTENDED_INTAKE = 6.0; //  degrees
    public static double ELBOW_CLOSE_INTAKE = 3.0; //   degrees
    public static double ELBOW_DEPOSIT = 145.0; //  degrees
    public static double ELBOW_DEPOSIT_SAFE = 135.0; //  degrees
    public static double ELBOW_TRAVEL = 25.0; //  degrees
