...
@Autonomous
class FinalsStackSide : AnchorOpMode() {
    ...
    val startPose = Pose2d(-32.25, 63.0, PI / 2)
...
//        val startPose = Pose2d(-32.0, 62.0, startHeading).adjustForAlliance(alliance)
        ...
        val transitLanePoseAfterPurplePixel =
            (Vector2d(-40.0, transitLaneY))
        val transitLaneBackDropSide =
            Vector2d(nearBackDropLaneX-16.0, transitLaneY).adjustForAlliance(alliance)
...
//            Vector2d(nearBackDropLaneX, nearBackDropCenter.y - backDropZoneSpacing)
        ...
        val parkInsidePosition = Vector2d(48.0, 48.0).adjustForAlliance(alliance)
        ...
        val backAwayFromStackTrajectory =
            drive.trajectoryBuilder(moveToStackTrajectory.end())
                .lineToLinearHeading(stackAxis)
                .build()
        val moveToTransitLaneTrajectory = drive.trajectoryBuilder(moveToScorePurplePixelTrajectory.end())
        ...
        val moveToBackdropTrajectory =
            drive.trajectoryBuilder(moveToTransitLaneTrajectory.end(), true)
...
//                .build()
        ...
        val parkInsideTrajectory = drive.trajectoryBuilder(moveToScoreBackDropTrajectory.end())
        ...
        val moveToTransitLine = TrajectoryFollower(drive, moveToTransitLaneTrajectory)
