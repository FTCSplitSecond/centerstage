...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double XMULTIPLIER = 48.25/48.0;
    public static double YMULTIPLIER = 47.7/48.0;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        super(Arrays.asList(
                new Pose2d(-1.9, LATERAL_DISTANCE / 2.0, 0), // left
                new Pose2d(-1.9, -LATERAL_DISTANCE /2.0, 0), // right
                new Pose2d(FORWARD_OFFSET, 3.4, Math.toRadians(90)) // front
        ));
