...
//
//@Autonomous
//class BlueStackCloseAuto : AnchorOpMode() {
...
//    val startPose = Pose2d(-36.0, 63.0, -PI / 2)
//    val alliance = Alliance.BLUE
//
//    override fun prerun() {
//        robot = Robot(hardwareMap, this.hardwareManager, telemetry, OpModeType.AUTONOMOUS, startPose)
...
//            Pose2d(Vector2d(-36.0, 60.0), -(2.25*PI)/6).adjustForAlliance(alliance)
//        val purplePixelPoseCenter =
//            Pose2d(Vector2d(-36.0, 60.0), -(2.5*PI)/6).adjustForAlliance(alliance)
//        val purplePixelPoseAwayFromBackdrop =
//            Pose2d(Vector2d(36.0, 60.0), -(3.55*PI)/6).adjustForAlliance(alliance)
...
//
//            parallel(
//                smec.setDepositPixelLevelAuto(2.0),
//                moveArmToDeposit,
//            ),
//
//            moveToNearBackdrop,
