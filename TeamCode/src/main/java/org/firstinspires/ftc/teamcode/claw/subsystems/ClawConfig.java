...
public class ClawConfig {
    ...
    public static double LEFT_SERVO_CLOSED_MICROSECONDS = 2000; // VALUE FOR AUTO ONLY: decrease to 1900 if the servo is under intensive use
     public static double LEFT_SERVO_DROP_MICROSECONDS = 1650;
    public static double RIGHT_SERVO_OPEN_MICROSECONDS = 1500.0;
    public static double RIGHT_SERVO_CLOSED_MICROSECONDS =  550.0; // VALUE FOR AUTO ONLY: increase to 850 if the servo is under intensive use
