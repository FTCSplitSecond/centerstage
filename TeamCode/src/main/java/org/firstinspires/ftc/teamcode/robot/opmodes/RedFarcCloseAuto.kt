...
@Autonomous
class RedFarcCloseAuto : AnchorOpMode() {
    ...
    val startPose = Pose2d(-36.0, -62.0, PI / 2)
...
//        val startPose = Pose2d(-32.0, 62.0, startHeading).adjustForAlliance(alliance)
        ...
        val purplePixelPoseBackdropSide =
            Pose2d(Vector2d(-36.0, 56.0), (2.25*PI)/6).adjustForAlliance(alliance)
        val purplePixelPoseCenter =
            Pose2d(Vector2d(-36.0, 54.0), (2.5*PI)/6).adjustForAlliance(alliance)
        val purplePixelPoseAwayFromBackdrop =
            Pose2d(Vector2d(-36.0, 56.0), (3.55*PI)/6).adjustForAlliance(alliance)
