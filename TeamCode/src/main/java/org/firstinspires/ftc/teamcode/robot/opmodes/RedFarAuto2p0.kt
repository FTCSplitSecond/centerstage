...
class RedFarAuto2p0 : AnchorOpMode() {
    ...
    override fun prerun() {
        ...
        parkLocation = AutoConfig.RED_FAR2P0_PARK
        delayA = AutoConfig.RED_FAR2P0_DELAYS[0]
    ...
    override fun run() {
        ...
        val delayB = AutoConfig.RED_FAR2P0_DELAYS[1]
        val delayC = AutoConfig.RED_FAR2P0_DELAYS[2]
