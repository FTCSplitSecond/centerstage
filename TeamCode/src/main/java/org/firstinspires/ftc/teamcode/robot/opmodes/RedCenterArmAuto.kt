...
@Autonomous
class RedCenterArmAuto : AnchorOpMode() {
...
//        val startPose = Pose2d(-32.0, 62.0, startHeading).adjustForAlliance(alliance)
        ...
        val purplePixelPoseCenter = Pose2d(Vector2d(-34.5, 51.0), -PI/2).adjustForAlliance(alliance)
        ...
        val leftClawStackPose = Pose2d(Vector2d(-105.0, 34.03), PI).adjustForAlliance(alliance)
