...
class BlueFarAuto2p0 : AnchorOpMode() {
    ...
    override fun prerun() {
        ...
        parkLocation = AutoConfig.BLUE_FAR2P0_PARK
        delayA = AutoConfig.BLUE_FAR2P0_DELAYS[0]
    ...
    override fun run() {
        ...
        val delayB = AutoConfig.BLUE_FAR2P0_DELAYS[1]
        val delayC = AutoConfig.BLUE_FAR2P0_DELAYS[2]
